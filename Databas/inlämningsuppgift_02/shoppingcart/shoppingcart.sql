...
--
-- Host: localhost:3306
-- Generation Time: Feb 15, 2021 at 02:31 PM
...
CREATE TABLE `customer` (
  ...
  `names` varchar(50) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
  ...
  `addresses` varchar(50) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL
